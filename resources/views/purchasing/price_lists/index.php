...
$t = [
    'ar' => [
        ...
        'search_placeholder' => 'ابحث برقم القائمة، العنوان، أو اسم المورد...', 'search_btn' => 'بحث', 'clear' => 'إلغاء',
        'status_active' => 'نشط', 'status_expired' => 'منتهي', 'status_draft' => 'مسودة', 'confirm_delete' => 'تأكيد الحذف؟'
    ],
    'en' => [
        ...
        'search_placeholder' => 'Search by list no, title, or supplier name...', 'search_btn' => 'Search', 'clear' => 'Clear',
        'status_active' => 'Active', 'status_expired' => 'Expired', 'status_draft' => 'Draft', 'confirm_delete' => 'Confirm delete?'
    ]
][$isRtl ? 'ar' : 'en'];
?>
...
<div class="mod-wrapper" dir="<?= $isRtl ? 'rtl' : 'ltr' ?>">
    ...
    <form action="/ERP/purchasing/price-lists" method="GET" class="search-bar">
        ...
        <?php if(!empty($search)): ?>
            <a href="/ERP/purchasing/price-lists" class="btn-clear"><i class="ph-bold ph-x"></i> <?= $t['clear'] ?></a>
        <?php endif; ?>
    </form>
                    ...
                    <?php else: foreach ($lists as $l): ?>
                        <tr>
                            ...
                            <td style="text-align: center; white-space: nowrap;">
                                ...
                                <form action="/ERP/purchasing/price-lists/<?= $l->id ?>/delete" method="POST" style="display:inline;" onsubmit="return confirm('<?= $t['confirm_delete'] ?>');">
